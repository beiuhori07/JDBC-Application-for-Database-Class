...
public class AdminPersonalDataPanel extends JPanel{
    ...
    AdminPersonalDataPanel(String username) {
        this.user = username;
        ...
        centerPanel.setLayout(new GridLayout(0, 2, 5, 20));
    ...
    public static void main(String[] args) {
        ...
        AdminPersonalDataPanel panel = new AdminPersonalDataPanel("user");
