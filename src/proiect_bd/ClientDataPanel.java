...
public class ClientDataPanel extends JPanel{
    ...
    JLabel badIdlabel = new JLabel("ID introdus incorect!", JLabel.CENTER);
    ...
    ClientDataPanel(String username) {
        this.user = username;
        ...
        badIdlabel.setFont(new Font("Dialog", Font.BOLD, 13));
        modifybtn.setFont(new Font("Dialog", Font.BOLD, 14));
        backbtn.setFont(new Font("Dialog", Font.BOLD, 14));
        filterbtn.setFont(new Font("Dialog", Font.BOLD, 14));
        ...
        rigidarea1.add(Box.createRigidArea(new Dimension(130, 0)));
        rigidarea1.add(modifybtn);
        rigidarea1.add(Box.createRigidArea(new Dimension(20, 0)));
        rigidarea1.add(backbtn);
        rigidarea1.add(Box.createRigidArea(new Dimension(20, 0)));
        rigidarea1.add(filterbtn);

        badIdlabel.setBounds(290, 470, 200, 25);
        badIdlabel.setForeground(Color.red);
        badIdlabel.setVisible(false);
        this.add(badIdlabel);
        idField.setBounds(500, 500, 150, 30);
        this.add(idField);
    ...
    public static void main(String[] args) {
        ...
        ClientDataPanel panel = new ClientDataPanel("user");
