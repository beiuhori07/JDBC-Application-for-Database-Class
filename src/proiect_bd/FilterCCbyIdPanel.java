...
public class FilterCCbyIdPanel extends JPanel{
    JPanel centralParentPanel = new JPanel();
    JLabel label = new JLabel("<html>Actiuni Cont Curent<br/>filtrate prin id client</htm>", JLabel.CENTER);
    ...
    public static void main(String[] args) {
        ...
        FilterCCbyIdPanel panel = new FilterCCbyIdPanel("hori");
